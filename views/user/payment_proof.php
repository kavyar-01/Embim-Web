...
<div class="max-w-xl mx-auto px-4 sm:px-6">
    ...
    <nav class="flex items-center gap-2 text-sm text-gray-400 pt-6 mb-8">
        <span class="text-gray-400">Konfirmasi Booking</span>
        <svg class="h-4 w-4" fill="none" stroke="currentColor" viewBox="0 0 24 24">
            <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M9 5l7 7-7 7"/>
        </svg>
        <span class="text-gray-700 font-semibold">Upload Bukti Pembayaran</span>
    </nav>
    ...
    <div class="flex items-center gap-2 mb-8">
        ...
        <div class="flex items-center gap-2">
            ...
            <span class="text-xs font-semibold text-blue-600 hidden sm:inline">Upload Bukti</span>
        </div>
        ...
        <div class="flex items-center gap-2">
            ...
            <span class="text-xs font-semibold text-gray-400 hidden sm:inline">Selesai</span>
        </div>
    </div>
    ...
    <div class="mb-5 bg-red-50 border border-red-200 rounded-2xl px-5 py-4">
        <p class="text-sm font-bold text-red-700 mb-1">Mohon perbaiki kesalahan berikut:</p>
        <ul class="space-y-1">
    ...
    <div class="bg-white rounded-2xl border border-gray-100 shadow-sm p-5 mb-5">
        <h2 class="text-xs font-bold text-gray-400 uppercase tracking-wider mb-4">Ringkasan Pesanan</h2>
    ...
    <form action="index.php?page=booking&step=upload-proof"
        ...
        <div class="bg-white rounded-2xl border border-gray-100 shadow-sm p-5 mb-5">
            <h2 class="text-xs font-bold text-gray-400 uppercase tracking-wider mb-1">Upload Bukti Pembayaran</h2>
            <p class="text-xs text-gray-400 mb-4">Screenshot atau foto struk transfer / pembayaran Anda.</p>
            ...
            >
                <div id="proof-placeholder" class="flex flex-col items-center gap-2 pointer-events-none">
                    ...
                    <p class="text-sm font-semibold text-gray-400">Klik untuk upload bukti</p>
            ...
            <p class="text-xs text-gray-400 flex items-center gap-1.5">
                ...
                Pastikan nominal dan nama penerima pada bukti terlihat jelas.
            </p>
        </div>
