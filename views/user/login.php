...
<body class="min-h-screen flex flex-col items-center justify-center py-12 px-4">
    ...
    <div class="login-card w-full max-w-md px-8 py-10 fade-up delay-1">
        ...
        <div class="fade-up delay-2">
            ...
            >
                ...
                <span>Login dengan No.Telepon</span>
            </button>
        </div>
    ...
    <div class="text-center mt-6 fade-up delay-5">
        <p class="text-xs text-gray-400 leading-relaxed max-w-sm mx-auto">
            ...
            <a href="#" class="underline hover:text-gray-600 transition">Syarat & Ketentuan</a>,
            <a href="#" class="underline hover:text-gray-600 transition">Kebijakan Privasi</a>, dan
            <a href="#" class="underline hover:text-gray-600 transition">Kebijakan Penggunaan</a>
            EMBIM.
        </p>
    </div>
        ...
        <div class="px-7 pt-6 pb-7">
            ...
            <div class="flex items-center gap-3 mb-5">
                ...
                <div>
                    ...
                    <p class="text-xs text-gray-400 mt-0.5">Masukkan nomor telepon terdaftar</p>
                </div>
            </div>
            ...
            <div class="mb-5">
                ...
                <p class="text-xs text-gray-400 mt-1.5">Gunakan nomor yang terdaftar di akun EMBIM Anda.</p>
            </div>
