<footer class="bg-white border-t border-gray-200">
  <div class="max-w-7xl mx-auto px-6 py-12">
    <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-10">
      ...
      <div class="space-y-4">
        <h3 class="text-xs font-bold text-gray-900 uppercase tracking-wider">Quick Links</h3>
  ...
  <div class="border-t border-gray-200">
    <div class="max-w-7xl mx-auto px-6 py-5 flex flex-col sm:flex-row items-center justify-between gap-3">
      <p class="text-xs text-gray-400">&copy; 2026 EMBIM. All rights reserved.</p>
      <div class="flex items-center gap-5">
        <a href="#" class="text-xs text-gray-400 hover:text-blue-600 transition-colors">Terms</a>
        <a href="#" class="text-xs text-gray-400 hover:text-blue-600 transition-colors">Privacy</a>
        <a href="#" class="text-xs text-gray-400 hover:text-blue-600 transition-colors">Cookies</a>
      </div>
    </div>
  </div>
</footer>
